...
NSString *const TI_APPLICATION_ID = @"com.aditi.xplore";
NSString *const TI_APPLICATION_PUBLISHER = @"not specified";
NSString *const TI_APPLICATION_URL = @"com.aditisuryawanshi.xclone";
NSString *const TI_APPLICATION_NAME = @"XLite";
NSString *const TI_APPLICATION_VERSION = @"1.0";
NSString *const TI_APPLICATION_DESCRIPTION = @"";
NSString *const TI_APPLICATION_COPYRIGHT = @"not specified";
NSString *const TI_APPLICATION_GUID = @"d936971a-eef1-4adb-80d6-51d9cbf557df";
