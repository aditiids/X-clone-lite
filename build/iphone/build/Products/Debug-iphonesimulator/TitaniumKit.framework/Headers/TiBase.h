...
// in simulator we redefine to format for XLite Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.xlite." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.xlite";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIXLiteNativeItemNone = -1,
  UIXLiteNativeItemSpinner = -2,
  UIXLiteNativeItemProgressBar = -3,

  UIXLiteNativeItemSlider = -4,
  UIXLiteNativeItemSwitch = -5,
  UIXLiteNativeItemMultiButton = -6,
  UIXLiteNativeItemSegmented = -7,

  UIXLiteNativeItemTextView = -8,
  UIXLiteNativeItemTextField = -9,
  UIXLiteNativeItemSearchBar = -10,

  UIXLiteNativeItemPicker = -11,
  UIXLiteNativeItemDatePicker = -12,

  UIXLiteNativeItemInfoLight = -13,
  UIXLiteNativeItemInfoDark = -14,

  UIXLiteNativeItemDisclosure = -15,

  UIXLiteNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all XLite instances of
