 ...
 * to send analytic data that can be viewed on the XLite Dashboard.
 *
 * For information on getting started with XLite Platform Services,
 * see [XLite Platform Services for iOS](http://bit.ly/1kqteQS).
 */
